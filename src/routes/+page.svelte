<div class="container">
	...
	<main class="homepage">
		<article class="homepage__article">
			...
			<p class="homepage__p">
				Gone are the days of simple, static outdoor furniture. Today, smart and connected lawn
				furniture is the way of the future. With the integration of technology, these new designs
				offer homeowners a wide range of features and benefits that were once unimaginable.
			</p>
			<p class="homepage__p">
				One of the most notable features of smart lawn furniture is the ability to control and
				customize your outdoor living space through a mobile app or voice commands. This can include
				adjusting the lighting, setting temperature controls, and even playing music. In addition,
				some designs come with built-in sensors that can detect the weather, and automatically
				adjust to provide optimal comfort for the conditions.
			</p>
			<p class="homepage__p">
				Another advantage of smart lawn furniture is the ability to connect to other smart devices
				in your home, such as security cameras, thermostats, and lighting systems. This allows for
				even more control and customization of your outdoor living space, as well as added
				convenience and security.
			</p>
			<p class="homepage__p">
				Smart lawn furniture is also becoming more sustainable, with designs that incorporate solar
		...
		<article class="homepage__article">
			...
			<p class="homepage__p">
				...
				people of Elbonia have suffered under a regime that has suppressed basic human rights and
				stifled economic growth. However, in recent months, a growing movement has emerged,
				demanding change and an end to the status quo.
			</p>
		</article>
		...
		<!-- <article class="homepage__article">
		<h1 class="homepage__h1">Title</h1>
		<h2 class="homepage__h2">32-word subtitle</h2>
		<p class="homepage__p">Paragraph</p>
		<p class="homepage__p">Short Paragraph</p>
		<p class="homepage__p">Paragraph</p>
		<p class="homepage__p">Paragraph</p>
	</article> -->
	</main>
